...
export function useReports() {
  ...
  // NUEVA FUNCIÓN PARA VER PDF EN MODAL
  const verReporte = async (reporteId) => {
    try {
      loading.value = true
      error.value = null
      const res = await fetchWithAuth(`${API_BASE}/reportes/${reporteId}/ver`, {
        method: 'GET'
      })
  ...
  return {
    ...
    listarMisReportes,
    obtenerReporte,
    verReporte, // Nueva función agregada
    descargarReporte,
    eliminarReporte,
    resetFormData,
