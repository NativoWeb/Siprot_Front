<template>
  <div v-if="visible" class="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50">
    <div class="bg-white rounded-2xl shadow-xl w-[90%] m-0-auto p-6 relative">
        ...
        <form @submit.prevent="uploadDocument">
          <div class="flex flex-col gap-8 mb-10">
            ...
            <div class="flex flex-col gap-4">
              ...
              <input type="file" ref="fileInput" @change="handleFileChange" accept=".pdf,.docx,.xlsx"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-8">
              <div class="flex flex-col gap-4">
                ...
                <input class="input-custom" type="text" v-model="documentTitle" required
                  placeholder="Título del documento">
              </div>
              <div class="flex flex-col gap-4">
                <label class="text-sm font-medium">Vigencia (Año) *</label>
                <input class="input-custom" type="number" v-model="documentYear" required placeholder="Ej: 2024"
              ...
              <div class="flex flex-col gap-4">
                ...
                <textarea v-model="additionalNotes" placeholder="Información adicional sobre el documento..."
                  class="resize-none input-custom"></textarea>
              </div>
            </div>
          </div>
          ...
          <div class="flex items-center justify-center gap-6 mt-8">
            ...
            <button class="shadow-custom bg-white cursor-pointer text-sm px-[12px] py-[7px] rounded-[6px]" type="button"
              @click="clearForm" :disabled="isUploading">
              Limpiar Formulario
            </button>
          </div>
        </form>
      ...
      <div v-if="showErrorNotification"
        ...
        <div class="flex">
          ...
          <div class="ml-auto pl-3">
            <div class="-mx-1.5 -my-1.5">
              <button @click="showErrorNotification = false"
...
// Dropdowns data
const sectors = ref(['Tecnología', 'Turismo', 'Agroindustria', 'Salud', 'Construcción'])
const coreLines = ref(['Innovación y Desarrollo', 'Formación para el Trabajo', 'Emprendimiento', 'Investigación Aplicada'])
const documentTypes = ref(['Plan de Desarrollo', 'Estudio Prospectivo', 'Matriz DOFA', 'Informe de Gestión', 'Reglamento'])
...
onMounted(() => {
  // Aquí podrías cargar valores dinámicos para los selects
})
</script>
