<template>
  <div class="program-bulk-upload bg-white shadow-md rounded-xl p-6">
    <h2 class="text-lg font-semibold text-gray-700 mb-4">Carga masiva de programas</h2>
    
    <!-- Información sobre el formato -->
    <div class="mb-4 p-4 bg-blue-50 border border-blue-200 rounded-lg">
      <h3 class="text-sm font-medium text-blue-800 mb-2">Formato requerido del archivo:</h3>
  ...
  methods: {
    ...
    async processFile() {
      ...
      try {
        ...
        // Emitir evento para actualizar la lista de programas
        this.$emit('uploaded');
