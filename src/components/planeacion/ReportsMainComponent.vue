...
import GenerarReporte from '@/components/reportes/GenerarReporte.vue'
import ListaReportes from '@/components/reportes/ListaReportes.vue'
...
onMounted(() => {
  ...
  try {
    ...
    if (decoded.exp && decoded.exp < currentTime) {
      ...
      router.push('/iniciar-sesion')
    } else if (decoded.role !== 'planeacion' && decoded.role !== 'superadmin') {
  ...
  <div class="reportes-container">
    ...
    <div class="tab-content">
      <div v-if="activeTab === 'generar'" class="tab-panel">
        <GenerarReporte @reporte-generado="onReporteGenerado" />
      </div>
      <div v-if="activeTab === 'mis-reportes'" class="tab-panel">
        <ListaReportes @reporte-eliminado="onReporteEliminado" />
      </div>
